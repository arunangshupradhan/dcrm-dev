...
<div class="main-content">
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="<?= site_url() ?>assets/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle img-thumbnail">
                                        </div>
    ...
    <!-- End Page-content -->
<script src="<?= site_url(); ?>assets/js/pages/saas-dashboard.init.js"></script>
<?= $this->endSection() ?>
