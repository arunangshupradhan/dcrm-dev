...
<div class="col-md-8 col-lg-6 col-xl-5">
    <div class="card overflow-hidden">
        ...
        <div class="card-body pt-0"> 
            ...
            <div class="p-2">
                ...
                <form class="form-horizontal" method="POST" action="<?= site_url('service-providers'); ?>" accept-charset="UTF-8">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                    ...
                    <div class="mt-4 text-center">
                        <a href="<?= site_url('service-providers/forgot-password') ?>" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                    </div>
                </form>
            </div>
    ...
    <div class="mt-5 text-center">
        ...
        <div>
            <p>Don't have an account ? <a href="<?= site_url('service-providers/sign-up') ?>" class="fw-medium text-primary"> Signup now </a> </p>
